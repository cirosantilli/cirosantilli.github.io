...
wikimedia_video::https://upload.wikimedia.org/wikipedia/commons/b/bb/River_water_sample_collection_with_a_bottle_and_string.ogv[]
...
wikimedia_video::https://upload.wikimedia.org/wikipedia/commons/3/3f/Vacuum_pump_filter_pour_sample_and_turn_on.webm[]

[source=https://commons.wikimedia.org/wiki/File:Vacuum_pump_filter_cut_and_place_in_eppendorf.webm]
wikimedia_video::https://upload.wikimedia.org/wikipedia/commons/8/85/Vacuum_pump_filter_cut_and_place_in_eppendorf.webm[]
...
wikimedia_image::https://upload.wikimedia.org/wikipedia/commons/thumb/c/c9/VWR_Micro_Star_17_microcentrifuge_loading.png/358px-VWR_Micro_Star_17_microcentrifuge_loading.png[]
