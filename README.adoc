...
xref:evil[] company that desecrated the beauty created by https://en.wikipedia.org/wiki/Sun_Microsystems[Sun], and is now {cirosantilli-wiki-oracle-v-google}[trying to bury Java once and or all]
