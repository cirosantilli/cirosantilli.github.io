...
Finally, there it was: a proper and precise definition of xref:mathematics[], including a definition of integers, reals and limits!
...
Most mathematicians can't code or deal with the real world in general however, so they haven't created the obviously necessary: xref:create-a-website-front-end-for-a-mathematical-formal-proof-system[].

The fact that Mathematics happens to be the best way to describe xref:physics[] and that humans can use physical intution heuristics to reach the NP-hard proofs of mathematics is one of the great miracles of the universe.
...
The artistic instrument that enables the ultimate art: coding. Much more useful than instruments used in inferior arts, such as pianos or paintbrushes.
