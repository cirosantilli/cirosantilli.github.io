...
* Default programming languages: Python and C++. xref:programming-language-choice[I'll learn Rust and Haskell once I'm rich]
...
In retrospect, I sometimes I wish I had focused on even greater impact things, some of them at: xref:projects-todo[]
...
My self-selected best answers are listed at: xref:articles[]
...
When I get an upvote on one of my more obscure answers, I often re-read it, and often find improvements to be made and make them.
...
My deep understanding of Stack Overflow mechanisms and its shortcomings also helped shape my ideas for: xref:write-free-books-to-get-famous-website[].
...
More thoughts on Stack Overflow at: xref:stack-overflow[]
...
In response, I decided to use my xref:stack-overflow-contributions[considerable Stack Overflow presence] to sabotage the website in China with keywords censored keywords on my username, for example: http://web.archive.org/web/20150602004401/https://stackoverflow.com/users/895245/ciro-santilli-%e5%85%ad%e5%9b%9b%e4%ba%8b%e4%bb%b6-%e6%b3%95%e8%bd%ae%e5%8a%9f-%e7%ba%b3%e7%b1%b3%e6%af%94%e4%ba%9a%e8%83%a1%e6%b5%b7%e5%b3%b0
...
This campaign has led me to have an insane profile view / reputation ratio, since many people pause to look at my profile. I am point "A" at the top right corner of xref:image-stack-overflow-reputation-profile-views-ciro-santilli[xrefstyle=full]:
...
Further analysis done at: https://stats.stackexchange.com/questions/376361/how-to-find-the-sample-points-that-have-statistically-meaningful-large-outlier-r
...
** xref:stack-overflow-vote-fraud-script[] How do you think I got xref:stack-overflow-contributions[my rep]? Just kidding. Stack Overflow later forbade me from advertising these project: xref:stack-overflow-suspension-for-vote-fraud-script-2019-03-20[]
...
* Because I xref:write-free-books-to-get-famous-website[care about education], around 2014 I looked into markup languages and version control for books, before I noticed that this approach was useless and that ranking algorithms are all that matter:
...
+
They send me a free swag bottle later after they got funding on to thank me for my contributions: xref:image-gitlab-bottle-beach[xrefstyle=full]. I had to pay for the beach trip though.
+
...
Then I found two websites that changed my life forever, and made be believe that there was an alternative: xref:stack-overflow-contributions[Stack Overflow] and {cirosantilli-github}[GitHub].
...
We needed a new educational system. One that would allow people to fulfill their potential and desires, and truly xref:ciro-santillis-ultimate-life-goal[improve society as a result], both in rich and poor countries.
...
Such advances could one day lead to both xref:ciro-santillis-ultimate-life-goal[biological super-AGI and immortality].
...
==== Create videos of all key physics experiments

Another thing that blows my mind is that you can't find easily on YouTube recreations of many of the key physics / chemistry experiments.
...
A bit like what Ciro Santilli does in his xref:stack-overflow-contributions[Stack Overflow contributions] but with computers!

I understand that some experiments are just to complex and expensive to re-create, as an extreme example say, a precise description of the https://en.wikipedia.org/wiki/Large_Hadron_Collider[LHC], but up to the mid 20th century? We should have all of those nailed down.
...
==== Ciro Santilli's ultimate life goal

https://en.wikipedia.org/wiki/Basic_income[Unconditional basic income] is my ultimate https://en.wikipedia.org/wiki/Transhumanism[non-transhumanist] technological dream: to reach a state of technological advancement and distribution of resources so high that everyone gets money for doing nothing, enough for:
...
Once a person has that, they can xref:write-free-books-to-get-famous-website[learn, teach] and create whatever they want. Or play video games all day long if they wish.
...
Humanity's best bet to achieve silicon AGI today is to work on: xref:design-a-large-cohesive-game-world-for-robotic-like-artificial-intelligence-development[]
...
Europe can't even unify basic things like a mariage registry, or the posting of parcels, which often get lost and require you to contact people who may not speak English.

For this reason, I believe Europe will only continue to go downhill with the years, and the UK will continue to try and endosymbiose into a state of the USA.

It is the European https://en.wikipedia.org/wiki/Tower_of_Babel[Tower of Babel].

=== How to contact Ciro Santilli

To contact Ciro Santilli publicly about any general subject that is not covered in a more specif repository, including saying hi or suggestions about his website, create a GitHub issue at: {cirosantilli-repo-url}/issues/new
...
If you need private contact, extract his email from on of my GitHub repos or use LinkedIn.
...
Ciro Santilli's website is licensed as: link:https://creativecommons.org/licenses/by-sa/4.0/[CC BY-SA 4.0] unless otherwise noted on a more specific page or header. The license can also be found at: link:LICENSE[].
...
* Swift: Apple is evil
* C#: xref:microsoft-windows[Microsoft] is evil
...
My stance towards China hasn't changed, and China comments and corrections about his website are still welcome as always.
...
An overview of Ciro Santilli's Stack Overflow contribution can be found at: xref:stack-overflow-contributions[].

=== Reply to Stack Overflow is doomed posts

I keep seeing those, so here is a reply.

Stack Overflow does have an super naive reputation and moderation system and overly restrictive subject matter, which I want to improve upon with: xref:write-free-books-to-get-famous-website[].

However, it is the best that we have now, and if you xref:stack-overflow-contributions[use it like me], you won't get tired:
...
I keep getting these evil ideas! Not that I would ever do anything like that, right?
...
+
Even if they don't, other people will still see your answer anyways, and this will lead to people to upvoting you more just to make your great answer surpass the current ones, especially i the accepted one has less upvotes than yours. Being second is often an asset.
...
This means of course that he will develop new features a bit slower than others, but I feel it is more valuable if end users can actually use your project in the first place.
...
Ciro Santilli doesn't know physics.

He writes about it partly to start playing with some scientific content for: xref:write-free-books-to-get-famous-website[], partly because this stuff is just amazingly beautiful. He is especially curious about xref:particle-physics[] and condensed matter.
...
Therefore this is evidence that xref:photon[photons] exist.
...
This is coherent with the xref:planck-einstein-relation[].
...
Currently an informal name for the https://en.wikipedia.org/wiki/Standard_Model[Standard Model].

Key outline of the theories:

* https://en.wikipedia.org/wiki/Schr%C3%B6dinger_equation[Schrodinger equation]
** Date: 1926
...
Physicists love to talk about that stuff, it must mean something I guess!
...
Some light YouTube channels, good for the first view, but not enough for me:
K
