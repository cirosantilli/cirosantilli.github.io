...
xref2:ciro-santilli[]'s xref2:stack-overflow[] contributions have, unsurprisingly, centered around the subjects he has worked with: systems programming and web development, and necessary tooling to get those done, such a Git, Python, Bash and Ubuntu.
...
This campaign has led him to have an insane profile view / reputation ratio, since many people pause to look at his profile. He is point "A" at the top right corner of xref2:image-stack-overflow-reputation-profile-views-ciro-santilli[xrefstyle=full]:
...
+
GitLab sent Ciro a free swag bottle later after they got funding on to thank him for his contributions: xref2:image-gitlab-bottle-beach[xrefstyle=full]. He had to pay for the beach trip though.
+
...
TODO: download all resources. Images are already half way because basically all already go through `image2`. But not sure I can mark external CSS and JavaScript easily on the HTML.
