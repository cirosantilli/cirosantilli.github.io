...
* Algorithms
** https://stackoverflow.com/questions/6147242/heap-vs-binary-search-tree-bst/29548834#29548834[Heap vs Binary Search Tree (BST)]
* Git internals
...
video::pdmODVYPDLA[youtube,height=400]
...
What happens when https://en.wikipedia.org/wiki/OpenCL[[the underdogs] get https://stackoverflow.com/questions/1780599/what-is-the-meaning-of-posix/31865755#31865755[together] and try to factor out their efforts to beat some https://en.wikipedia.org/wiki/CUDA[evil] dominant xref2:microsoft-windows[power].
