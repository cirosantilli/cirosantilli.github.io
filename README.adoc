...
<div class="${canvas_demo_prefix}" id="${this_demo_prefix}_wrapper">
    <div>enable: <input type="checkbox" id="${this_demo_prefix}_enable"></input> &lt;-- (click this to run!!!)</div>
    ...
    <div>save images: <input type="checkbox" id="${this_demo_prefix}_save-images-checkbox"></input> (some images are skipped if FPS is high)</div>
