= Ciro Santilli (三西猴)
:description: Software engineer. Passion for computers, natural sciences and education. Opinions are my own.
:docinfo: shared
:eqnums: all
:idprefix:
:idseparator: -
...
* Ciro will want some unsupported extensions, notably mathematics, likely with <<mathematics-typesetting-setup-of-ciro-santillis-website,Katex server side>>:
