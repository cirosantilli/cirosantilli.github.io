...
:wikipedia-lamb-shift: https://en.wikipedia.org/wiki/Lamb_shift[Lamb shift]
...
* https://en.wikipedia.org/wiki/Dirac_equation[Dirac's equation]
** Date: 1928
** Numerical predictions:
*** Hydrogen spectra including 2p split, but excluding even finer structure such as 2s / 2p split ({wikipedia-lamb-shift})
...
** Date: 1947 onwards
** Numerical predictions:
*** 2s / 2p split ({wikipedia-lamb-shift})
** Qualitative predictions:
*** Antimatter
*** Spin as part of the equation
