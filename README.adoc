...
Ciro feels that the largest revolutions since the 1950's have been quantum related, and will continue to be for a while, from deeper understanding of chemistry and materials to xref2:quantum-computing[], understanding and controlling quantum systems is where the most interesting frontier of technology lies.
...
* xref2:schrodinger-equation[]: major lines predicted, but not finer line splits like
* xref2:dirac-equation[]: explains xref2:fine-structure[] but not xref2:lamb-shift[]
* xref2:quantum-electrodynamics[]: xref2:lamb-shift[]

===== Fine structure

https://en.wikipedia.org/wiki/Fine_structure

Split in energy levels due to interaction between electron up or down spin and the electric field.

Well explained by the xref2:dirac-equation[], which is the main triumph of the equation.
...
* TODO why is the electron spin half. Half must mean half of that which is seen in transitions between atomic orbitals.
