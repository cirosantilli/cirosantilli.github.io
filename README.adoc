...
More thoughts on Stack Overflow at: <<stack-overflow>>
...
This campaign has led me to have an insane profile view / reputation ratio, since many people pause to look at my profile. I am point "A" at the top right corner of <<image-stack-overflow-reputation-profile-views-ciro-santilli>>:
...
** <<stack-overflow-vote-fraud-script>> How do you think I got <<stack-overflow-contributions,my rep>>? Just kidding. Stack Overflow later forbade me from advertising these project: <<stack-overflow-suspension-for-vote-fraud-script-2019-03-20>>
...
+
They send me a free swag bottle later after they got funding on to thank me for my contributions: <<image-gitlab-bottle-beach>>. I had to pay for the beach trip though.
+
...
We needed a new educational system. One that would allow people to fulfill their potential and desires, and truly <<ciro-santillis-ultimate-life-goal,improve society as a result>>, both in rich and poor countries.
...
Such advances could one day lead to both <<ciro-santillis-ultimate-life-goal,biological super-AGI and immortality>>.
...
==== Create videos of all key physical experiments
...
In particular, videos that are completely reproducible, indicating the exact model of every experimental element used, and how the experiment is setup. A bit like what I do in my <<stack-overflow-contributions>>!
...
To contact Ciro Santilli publicly about any general subject that is not covered in a more specif repository, including saying hi or suggestions about this website, create a GitHub issue at: {cirosantilli-repo-url}/issues/new
...
link:https://en.wikipedia.org/wiki/Disqus[Disqus comments] were removed from this website in 2019-05-04, a manual dump is link:/disqus-archive/[available here], removal rationale: <<why-ciro-santilli-removed-disqus-comments-from-this-website-in-2019-05-04>>.
...
This website was originally written in Markdown and link:https://github.com/jekyll/jekyll[Jekyll], however those were deprecated in favour of Asciidoctor when Ciro saw the light, rationale shown at: link:/markdown-style-guide#use-asciidoc[]
...
* Swift: Apple is evil
* C#: <<microsoft-windows,Microsoft>> is evil
...
=== Unmigrated sections of the old version of this website
...
=== Why Ciro Santilli removed Disqus comments from this website in 2019-05-04
...
An overview of Ciro Santilli's Stack Overflow contribution can be found at: <<stack-overflow-contributions>>.

=== Reply to Stack Overflow is doomed posts

I keep seeing those, so here is a reply.

Stack Overflow does have an super naive reputation and moderation system and overly restrictive subject matter, which I want to improve upon with: <<write-free-books-to-get-famous-website>>.

However, it is the best that we have now, and if you <<stack-overflow-contributions,use it like me>>, you won't get tired:
...
Time to embarrass myself with stuff I don't know. Partly to start playing with some scientific content for: <<write-free-books-to-get-famous-website>>, partly because this stuff is just amazing. I'm especially curious about <<particle-physics>> and condensed matter.
...
** Date: 1928
** Numerical predictions:
*** Hydrogen spectra including 2p split, but excluding even finer structure such as <<lamb-shift>>
...
Used to explain: <<blackbody-radiation-experiment>>
...
* the linear one can be made from a superposition of cirlar ones
* straight antennas produce linearly prolaized photos, and https://en.wikipedia.org/wiki/Helical_antenna[Helical antennas] circularly polarized ones
* a jump between 2s and 2p in an atom changes angular momentum. Therefore, the photon must cary angular momemtum as well as energy.
