...
In terms of per year reputation ranks, Ciro was in the top 100 in 2018: https://stackexchange.com/leagues/1/year/stackoverflow/2018-01-02 with 38,710 reputation. Note that daily repuation is mostly capped to 200 per day, leading to a maximum 73000 per year. It is possible to overcome this limit either with bounties or accepts, and Ciro find it amazing that some people actually break the 73k limit by far with accepts, e.g. Gordon Linoff reached 135k in 2018! However, this is something that Ciro will never do, because it implies answering thousands and thousands of useless semi duplicate questions as fast as possible to get the accept. Ciro's reputation is purely upvote on important question, and is therefore sustainable without any extra effort once achieved.
...
* the God-like Windows-only prorietary language lacking Visual Studio

Prgrammers of the world: unite! Focus on one IDE, and make it work for all languages and all bild systems. Give it all the features that Eclipse has, but none of the bugginess. Work with top project to make sure the IDE works for all top projects.
