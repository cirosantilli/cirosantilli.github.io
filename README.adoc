...
image2::Ciro_Santilli_with_his_Stack_Overflow_100k_reputation_cup.jpg[height=400]
...
Ciro is a reptilian-like being with cold hands and feet and low blood pressure. For this reason he believes that he will die of cancer or some respiratory problem. If the xref2:ciro-santillis-campaign-for-freedom-of-speech-in-china[Chinese government] doesn't get him first that is.
...
Could https://en.wikipedia.org/wiki/California[] be Ciro's https://en.wikipedia.org/wiki/Mecca[Mecca]?
...
Movies that are very expensive to make tend to be bad, because they have to make returns and thus appeal to a large amorphous population without any specialization. See e.g. xref2:primer-2004[] and xref2:other-very-good-movies[The Man from Earch (2017)].
...
* https://en.wikipedia.org/wiki/The_Man_from_Earth[The Man from Earth (2007]). Low budget.
