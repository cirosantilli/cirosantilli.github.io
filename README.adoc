...
My contributions have, unsurprisingly, centered around the subjects I have worked with: systems programming and web development, and necessary tooling to get those done, such a Git and Python.
...
For this reason, https://stackoverflow.com/help/badges/17/necromancer[Necromancer] is my favorite badge (get 5 upvotes on a question older than 60 days), and https://data.stackexchange.com/stackoverflow/query/300735/users-with-most-necromancer-badges-at-a-given-date?Date=2016-06-17[I was the #2 user with the most of this badge as of June 2016].

As of July 2019, https://data.stackexchange.com/stackoverflow/query/300735/users-with-most-necromancer-badges-at-a-given-date?Date=2019-07-01[I am very close to #1], only 2 badges slightly behind link:https://stackoverflow.com/users/6309[VonC], who has about 16 times more answers than me in total!

From this query: https://data.stackexchange.com/stackoverflow/query/1072396?&Date=2019-07-01&UserId=895245 it can be seen that as of July 2019, 1216 out of my 1329 answers were answered 60 days after the questions and constitute potential necromancers! Compare that to VonC's 1643 potential necromancers out of 21767 answers!
...
==== Design a large cohesive game world for robotic-like artificial intelligence development TODO

==== Create a website front-end for a mathematical formal proof system TODO
...
==== Key philosophies TODO

English and european union.
