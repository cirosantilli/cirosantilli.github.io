...
image2::xi-jinping-chrysanthemum-230-liusi.jpeg[height=230]
...
image2::stack-overflow-reputation-profile-views-ciro-santilli.png[height=473]
...
image2::gitlab-bottle-beach.jpg[height=225]
...
image2::ai-game-2d-continuous-basketball.png[height=531]
...
First, during the 2000's, the cost of sequencing fell to about 1000 USD per genome in the end of the 2010's: xref:image-cost-per-genome-vs-moore-s-law-from-2000-to-2019[xrefstyle=full]. The medical consequences of this revolution are still trickling down the application ladder today, inevitably, but somewhat slowly due to tight control of medical records.

.Cost per genome vs Moore's law from 2000 to 2019
wikimedia_image::https://upload.wikimedia.org/wikipedia/commons/thumb/0/01/Cost_per_Genome.png/1024px-Cost_per_Genome.png[height=400]
...
* Biology
** link:oxford-nanopore-river-bacteria[How to use an Oxford Nanopore MinION to extract DNA from river water and determine which bacteria live in it]
...
The https://en.wikipedia.org/wiki/Linguistic_relativity[Sapir–Whorf hypothesis] is bullshit outside of poetry, and the ending of https://en.wikipedia.org/wiki/Arrival_(film)[Arrival (2016)] makes one want to puke, where learning a language changes not only your brain, but also Ciro's precious xref:physics["laws" of Physics]!

Much more likely are xref:++https://en.wikipedia.org/wiki/To_Serve_Man_(The_Twilight_Zone)++[To Serve Man] / https://en.wikipedia.org/wiki/A_Small_Talent_for_War[A Small Talent for War] events!

Remember that those ideas come from a person who xref:ciro-santilli-s-natural-languages-skills[speaks 3.5 languages in 2019], and see absolutely no practical difference between them.
...
Quotes by other people can be found at: xref:the-best-original-quotes-presenced-by-ciro-santilli[]
...
____
Whereas https://en.wikipedia.org/wiki/Turing_completeness[Turing completeness] is enough for xref:mathematicians[mathematicians], humans need "run-on-Debian-complete".
____
...
* https://commons.wikimedia.org/wiki/Main_Page[Wikimedia Commons] if the format (no ZIPs) and License (CC BY SA, no fair use) are accepted there. This will be done for most of our own work images.
+
Wikimedia Commons scope is "eduationa material in a broad sense": https://commons.wikimedia.org/wiki/Commons:Project_scope[], and I don't think they will be too picky even with low quality photos.
* use the separate GitHub repository: https://github.com/cirosantilli/media But then we are at the mercy of GitHub's 1GB size policy: https://help.github.com/en/articles/what-is-my-disk-quota[]. GitLab however has a 10Gb maximum size: https://about.gitlab.com/2015/04/08/gitlab-dot-com-storage-limit-raised-to-10gb-per-repo/ so we could move there is we ever blow up 1Gb on GitHub.
* https://archive.org for random images from the web which don't have a clear license or that have a license that is not compatible with Wikimedia.
+
Never trust a website that is not on GitHub pages, for-profit companies will take down everything immediately as soon as it stops making them money. By the way, every external link to non-GitHub pages must be archived.
+
If the image does have a license compatible with Wikimedia, then just upload to Wikimedia and use that.
...
For videos, YouTube does not allow download even of Creative Commons videos: https://www.quora.com/Can-I-download-Creative-Commons-licensed-YouTube-videos-to-edit-them-and-use-them so uploading only there is not acceptable as it prevents reuse.
...
* xref:the-most-important-projects-done-by-ciro-santilli[actual projects] matter much more than those pieces of paper called Diplomas, you should not do like me, and instead grow some balls and focus entirely on your projects:
+
...
** https://en.wikipedia.org/wiki/Freeman_Dyson[Freeman Dyson]: https://www.youtube.com/watch?v=DzC1IRYN_Ps[Freeman Dyson - Why I don't like the PhD system (95/157)] by xref:web-of-storieswes[] published on Sep 6, 2016
...
Poet, scientists and warriors all in one.
...
Or from xref:ciro-santilli-s-best-random-thoughts[]:
...
Ciro's best quotes selected by no one other than Ciro can be found at: xref:ciro-santilli-s-best-random-thoughts[].
...
But xref:the-best-original-quotes-presenced-by-ciro-santilli[quoting S.]:
...
Electronic Ink such as that found on Amazon Kindle is the greatest invention ever made by man, as it allows xref:ciro-santilli[] to spend his entire life in front of a screen rather in the real world without getting tired eyes, and even if it is sunny outside.
...
And it underpins xref:biology[].

== Biology

https://en.wikipedia.org/wiki/Biology

xref:ciro-santilli[] believes that xref:molecular-biology-is-the-next-big-thing-so-do-anything-in-that-area[].
