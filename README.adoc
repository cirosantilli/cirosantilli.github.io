...
Originally done with silver in 1921, but even clearer was the hydrogen reproduction in 1927 by T.E. Phipps and J.B. Taylor.
...
* the basis for the most promising 2019 xref2:quantum-computing[quantum computers]
