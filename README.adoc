...
Ciro tends to take most pride on his systems programming answers, which is a subject that truly relatively few people know about. And his "media related answers" (3D graphics, audio, video), which can be are artsy and fun.
...
The https://en.wikipedia.org/wiki/Linguistic_relativity[Sapir–Whorf hypothesis] is bullshit outside of poetry, and the ending of https://en.wikipedia.org/wiki/Arrival_(film)[Arrival (2016)] makes one want to puke, where learning a language changes not only your brain, but also my precious xref:physics["laws" of Physics]!
...
* As iron sharpens iron, so one person sharpens another. Bible, https://en.wikipedia.org/wiki/Book_of_Proverbs[Proverbs] 27:17.

I presenced, so likely paraphrased and anonymized:
